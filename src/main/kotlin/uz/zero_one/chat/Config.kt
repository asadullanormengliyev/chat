...
class SecurityConfig(private val jwtAuthenticationFilter: JwtAuthenticationFilter) {
    ...
    fun corsConfigurationSource(): CorsConfigurationSource {
        ...
        configuration.allowedOrigins = listOf("http://localhost:5173","https://sage-sunburst-60ba08.netlify.app","https://chat-h80l.onrender.com","https://6120d8c2a946.ngrok-free.app")
...
class WebSocketConfig(private val userServiceImpl: UserServiceImpl) : WebSocketMessageBrokerConfigurer {
    ...
    override fun registerStompEndpoints(registry: StompEndpointRegistry) {
        registry.addEndpoint("/chat")
            .setAllowedOriginPatterns("http://localhost:5173","https://sage-sunburst-60ba08.netlify.app","https://chat-h80l.onrender.com","https://6120d8c2a946.ngrok-free.app")
             .withSockJS()
    }
